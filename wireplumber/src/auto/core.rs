...
use crate::{Conf, Object, ObjectManager, Properties, SpaJson};
use glib::{
    prelude::*,
...
impl Core {
    ...
    pub fn connect(&self) -> bool {
        unsafe { from_glib(ffi::wp_core_connect(self.to_glib_none().0)) }
    }
    ...
    //pub fn find_object(&self, func: /*Unimplemented*/Fn(/*Unimplemented*/Option<Basic: Pointer>) -> bool, data: /*Unimplemented*/Option<Basic: Pointer>) -> /*Unimplemented*/Option<Basic: Pointer> {
    ...
    pub fn conf(&self) -> Option<Conf> {
        unsafe { from_glib_full(ffi::wp_core_get_conf(self.to_glib_none().0)) }
    }
    ...
    pub fn idle_add<P: Fn() -> bool + 'static>(&self, function: P) -> glib::Source {
        ...
        unsafe extern "C" fn function_func<P: Fn() -> bool + 'static>(
    ...
    pub fn is_connected(&self) -> bool {
        unsafe { from_glib(ffi::wp_core_is_connected(self.to_glib_none().0)) }
    }

    #[doc(alias = "wp_core_load_component")]
    pub fn load_component<P: FnOnce(Result<(), glib::Error>) + 'static>(
        &self,
        ...
        unsafe extern "C" fn load_component_trampoline<
        ...
        >(
            ...
            let _ = ffi::wp_core_load_component_finish(_source_object as *mut _, res, &mut error);
    ...
    pub fn sync<P: FnOnce(Result<(), glib::Error>) + 'static>(
        &self,
        cancellable: Option<&impl IsA<gio::Cancellable>>,
        callback: P,
    ) -> bool {
        ...
        let user_data: Box_<glib::thread_guard::ThreadGuard<P>> =
            Box_::new(glib::thread_guard::ThreadGuard::new(callback));
        unsafe extern "C" fn sync_trampoline<P: FnOnce(Result<(), glib::Error>) + 'static>(
            _source_object: *mut glib::gobject_ffi::GObject,
            res: *mut gio::ffi::GAsyncResult,
            user_data: glib::ffi::gpointer,
        ) {
    ...
    pub fn sync_future(
        ...
        Box_::pin(gio::GioFuture::new(self, move |obj, cancellable, send| {
            obj.sync(Some(cancellable), move |res| {
                send.resolve(res);
            });
        }))
    }
    ...
    pub fn sync_closure(
        ...
        unsafe {
            from_glib(ffi::wp_core_sync_closure(
                self.to_glib_none().0,
                cancellable.map(|p| p.as_ref()).to_glib_none().0,
                closure.to_glib_none().0,
            ))
    ...
    pub fn test_feature(&self, feature: &str) -> bool {
        unsafe {
            from_glib(ffi::wp_core_test_feature(
                self.to_glib_none().0,
    ...
    pub fn timeout_add<P: Fn() -> bool + 'static>(
        &self,
        timeout_ms: u32,
        function: P,
    ) -> glib::Source {
    ...
    pub fn timeout_add_closure(&self, timeout_ms: u32, closure: &glib::Closure) -> glib::Source {
        unsafe {
            let mut source = std::ptr::null_mut();
            ffi::wp_core_timeout_add_closure(
                self.to_glib_none().0,
                &mut source,
                timeout_ms,
                closure.to_glib_none().0,
    ...
    pub fn connect_connected<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn connected_trampoline<F: Fn(&Core) + 'static>(
            this: *mut ffi::WpCore,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_disconnected<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn disconnected_trampoline<F: Fn(&Core) + 'static>(
            this: *mut ffi::WpCore,
            f: glib::ffi::gpointer,
        ) {
            let f: &F = &*(f as *const F);
    ...
    pub fn connect_pw_core_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pw_core_trampoline<F: Fn(&Core) + 'static>(
            this: *mut ffi::WpCore,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::pw-core\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(
                    notify_pw_core_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
