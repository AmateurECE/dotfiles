...
impl Conf {
    ...
    pub fn name(&self) -> Option<glib::GString> {
        unsafe { from_glib_none(ffi::wp_conf_get_name(self.to_glib_none().0)) }
    }
    ...
    pub fn section(&self, section: &str) -> Option<SpaJson> {
        unsafe {
            from_glib_full(ffi::wp_conf_get_section(
                self.to_glib_none().0,
    ...
    pub fn is_open(&self) -> bool {
        unsafe { from_glib(ffi::wp_conf_is_open(self.to_glib_none().0)) }
    }
    ...
    //pub fn parse_pw_context_sections(&self, context: /*Ignored*/Option<&mut pipewire::pw_context>) {
    ...
    pub fn section_update_props(&self, section: &str, props: &Properties) -> i32 {
        unsafe {
            ffi::wp_conf_section_update_props(
                self.to_glib_none().0,
                section.to_glib_none().0,
